...
namespace SMod3.Module.EventHandlers
{
	...
	public interface IEventHandlerPlayerDropAllAmmos : IEventHandler
	{
		/// <summary>
		/// This is called when all of the ammos of the player are going to be dropped.
		/// </summary>
		void OnPlayerDropAllAmmos(PlayerDropAllAmmosEvent ev);
	}

	public interface IEventHandlerPlayerCurrentItemUpdate : IEventHandler
	{
		/// <summary>
		/// This is called when the player changes the current item in hand.
		/// </summary>
	...
	public interface IEventHandlerRadioChatting : IEventHandler
	{
		/// <summary>
		/// Called when a player is chatting via radio
		/// </summary>
		void OnPlayerRadioChatting(PlayerRadioChattingEvent ev);
	}

	public interface IEventHandlerTransmission : IEventHandler
	{
		/// <summary>
		/// Called when a player voice is transmitted
		/// </summary>
		void OnPlayerTransmission(PlayerTransmissionEvent ev);
	}
