...
namespace SMod3.Module.EventSystem.Events
{
    ...
    public class PlayerPocketDimensionExitEvent : PlayerEvent
    {
        ...
        public PlayerPocketDimensionExitEvent(Player player, Vector3 exitPosition, bool allow) : base(player)
        {
    ...
    public class PlayerPocketDimensionEnterEvent : PlayerEvent
    {
        ...
        public PlayerPocketDimensionEnterEvent(Player player, float damage, Vector3 lastPosition, Vector3 targetPosition, Player attacker, bool allow) : base(player)
        {
            Damage = damage;
    ...
    public class PlayerThrowGrenadeEvent : PlayerEvent
    {
        ...
        public PlayerThrowGrenadeEvent(Player player, GrenadeType grenadeType, Vector3 direction, bool slowThrow, bool removeItem, bool allow) : base(player)
        {
    ...
    public class PlayerSpawnRagdollEvent : PlayerEvent
    {
        ...
        public PlayerSpawnRagdollEvent(Player player, RoleType roleType, Vector3 position, Vector3 rotation, Player attacker, DamageType damageType, bool allowRecall) : base(player)
        {
            Role = roleType;
            Position = position;
            Rotation = rotation;
    ...
    public class PlayerShootEvent : PlayerEvent
    {
        ...
        public PlayerShootEvent(Player player, Player target, Weapon weapon, WeaponSound? weaponSound, Vector3 sourcePosition, Vector3 targetPosition, string targetHitbox, Vector3 direction, bool spawnHitmarker = true, bool spawnBloodDecal = true) : base(player)
        {
            Target = target;
            Weapon = weapon;
    ...
    public class Player106CreatePortalEvent : PlayerEvent
    {
        ...
        public Player106CreatePortalEvent(Player player, Vector3 position, bool allow) : base(player)
        {
            Position = position;
            Allow = allow;
        }
    ...
    public class Player106TeleportEvent : PlayerEvent
    {
        ...
        public Player106TeleportEvent(Player player, Vector3 position) : base(player)
        {
            Position = position;
        }
    ...
    public class PlayerElevatorUseEvent : PlayerEvent
    {
        ...
        public PlayerElevatorUseEvent(Player player, Elevator elevator, Vector3 elevatorPosition, bool allowUse) : base(player)
        {
            Elevator = elevator;
    ...
    public class PlayerGrenadeExplosion : PlayerEvent
    {
        ...
        public PlayerGrenadeExplosion(Player thrower, GrenadeType grenadetype, Vector3 position, bool allow = true) : base(thrower)
        {
            Allow = allow;
            GrenadeType = grenadetype;
            Position = position;
    ...
    public class Player079CameraTeleportEvent : PlayerEvent
    {
        ...
        public Player079CameraTeleportEvent(Player player, Vector3 camera, bool allow, float apDrain) : base(player)
        {
            Camera = camera;
            Allow = allow;
            APDrain = apDrain;
    ...
    public class Player079ElevatorTeleportEvent : PlayerEvent
    {
        ...
        public Player079ElevatorTeleportEvent(Player player, Vector3 camera, Elevator elevator, bool allow, float apDrain) : base(player)
        {
            Camera = camera;
            Elevator = elevator;
            Allow = allow;
