        ...
        public void LoadPlugin(Assembly assembly)
        {
            ...
            foreach (var type in typesForSearch)
            {
                try
                {
                    ...
                    var pluginCCtor = type.GetConstructor(BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Instance | BindingFlags.CreateInstance, null, Type.EmptyTypes, null);
